...
class DQNAgent:
    def __init__(self, state_size, action_size, proprioception_size=2):
        ...
        performerFollowKey = BrainFunction(state_size, proprioception_size, action_size, [ReplayMemory(5000)], self.skip_frames)
        performerGetKey = BrainFunction(state_size, proprioception_size, action_size, [ReplayMemory(5000)], self.skip_frames)
        performerSearchKey = BrainFunction(state_size, proprioception_size, action_size, [ReplayMemory(5000)], self.skip_frames)
        performerEating = BrainFunction(state_size, proprioception_size, action_size, [ReplayMemory(5000)], self.skip_frames)
        performerFollowTel = BrainFunction(state_size, proprioception_size, action_size, [ReplayMemory(5000)], self.skip_frames)
